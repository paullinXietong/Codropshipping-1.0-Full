          ...
          <div class="flex flex-wrap gap-y-5 gap-x-4">
            <div v-for="item in relatedList" :key="`${item.offerId}-${item.source}`" class="productItem shadow rounded-md">
              <NuxtLink 
                ...
                target="_blank">
                <img class="max-h-64 h-48 w-full object-cover object-left cursor-pointer rounded" :src="item.main_image" :alt="item.title">
                ...
                <!-- <div class="-mt-5 flex justify-center absolute">
                  <div class="absolute -top-2 -left-1 p-0.5 rounded-full" style="background: #FDA05E;">
                    <svg t="1765963571609" class=" flex-shrink-0 icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="24975" width="32" height="32"><path d="M512.5 64.1h-2.6c-246.1 0-445.5 199.5-445.5 445.5v2.5h448.1v-448z" fill="#2F0F7D" p-id="24976"></path><path d="M512.1 445.2v66.9h448.3c0-22.7-1.7-45.1-5-66.9H512.1z" fill="#DE001A" p-id="24977"></path><path d="M940.1 378.3h-428v66.9h443.3c-3.4-22.9-8.6-45.3-15.3-66.9z" fill="#FFFFFF" p-id="24978"></path><path d="M913 311.3H512.1v66.9h428c-7.3-23.1-16.4-45.5-27.1-66.9z" fill="#DE001A" p-id="24979"></path><path d="M871.6 244.4H512.1v66.9H913c-11.9-23.6-25.7-45.9-41.4-66.9z" fill="#FFFFFF" p-id="24980"></path><path d="M810.2 177.5H512.1v66.9h359.5c-18.1-24.3-38.7-46.8-61.4-66.9z" fill="#DE001A" p-id="24981"></path><path d="M711.2 110.5H512.1v66.9h298.1c-29.7-26.4-63-49-99-66.9z" fill="#FFFFFF" p-id="24982"></path><path d="M313.6 913.7h397.5c36-17.9 69.3-40.5 99.1-66.9H214.6c29.7 26.5 63 49.1 99 66.9z" fill="#DE001A" p-id="24983"></path><path d="M214.6 846.8h595.6c22.6-20.2 43.2-42.6 61.4-66.9H153.2c18.1 24.3 38.7 46.7 61.4 66.9zM512.4 960.1c71.4 0 138.9-16.7 198.8-46.4H313.6c59.9 29.7 127.4 46.4 198.8 46.4z" fill="#FFFFFF" p-id="24984"></path><path d="M153.2 779.9h718.5c15.7-21 29.5-43.4 41.4-66.9H111.8c11.9 23.5 25.7 45.9 41.4 66.9z" fill="#DE001A" p-id="24985"></path><path d="M111.8 712.9H913c10.7-21.4 19.8-43.8 27.1-66.9H84.7c7.3 23.2 16.4 45.5 27.1 66.9z" fill="#FFFFFF" p-id="24986"></path><path d="M84.7 646H940c6.8-21.7 11.9-44 15.4-66.9h-886C72.8 602 78 624.3 84.7 646z" fill="#DE001A" p-id="24987"></path><path d="M955.4 579.1c3.3-21.8 5-44.2 5-66.9h-896c0 22.7 1.7 45.1 5 66.9h886z" fill="#FFFFFF" p-id="24988"></path><path d="M711.2 110.5c-59.9-29.7-127.4-46.4-198.8-46.4h-0.3v46.4h199.1z" fill="#DE001A" p-id="24989"></path><path d="M138.1 317.4l-8 16-17.9 2.6 13 12.5-3.1 17.6 16-8.3 16 8.3-3.1-17.6 12.9-12.5-17.8-2.6zM146.1 461.2l-8-16-8 16-17.9 2.6 13 12.5-3.1 17.6 16-8.3 16 8.3-3.1-17.6 12.9-12.5zM182.9 299.2l16-8.4 16 8.4-3-17.7 12.9-12.4-17.9-2.6-8-16-8 16-17.8 2.6 12.9 12.4zM224.8 399.9l-17.9-2.6-8-16-8 16-17.8 2.6 12.9 12.5-3.1 17.6 16-8.3 16 8.3-3-17.6zM360.2 186.6l-8 16-17.9 2.6 13 12.4-3.1 17.7 16-8.4 16 8.4-3.1-17.7 12.9-12.4-17.8-2.6zM344.2 116.6l16-8.3 16 8.3-3.1-17.6L386 86.5l-9.7-1.4c-10.7 3.4-21.3 7.2-31.7 11.4l2.5 2.5-2.9 17.6zM360.2 317.4l-8 16-17.9 2.6 13 12.5-3.1 17.6 16-8.3 16 8.3-3.1-17.6L386 336l-17.8-2.6zM368.2 461.2l-8-16-8 16-17.9 2.6 13 12.5-3.1 17.6 16-8.3 16 8.3-3.1-17.6 12.9-12.5zM405 299.2l16-8.4 16 8.4-3-17.7 12.9-12.4-17.9-2.6-8-16-8 16-17.8 2.6 12.9 12.4zM405 180.5l16-8.3 16 8.3-3-17.6 12.9-12.5-17.9-2.6-8-16-8 16-17.8 2.6 12.9 12.5zM446.9 399.9l-17.9-2.6-8-16-8 16-17.8 2.6 12.9 12.5L405 430l16-8.3 16 8.3-3-17.6zM96.3 430l-3.1-17.6 12.9-12.5-17.9-2.6-5.8-11.7c-3.8 13.1-7.1 26.4-9.8 40l7.6-4 16.1 8.4zM250.7 186.6l-8 16-17.9 2.6 12.9 12.4-3 17.7 16-8.4 15.9 8.4-3-17.7 12.9-12.4-17.9-2.6zM250.7 317.4l-8 16-17.9 2.6 12.9 12.5-3 17.6 16-8.3 15.9 8.3-3-17.6 12.9-12.5-17.9-2.6zM258.6 461.2l-7.9-16-8 16-17.9 2.6 12.9 12.5-3 17.6 16-8.3 15.9 8.3-3-17.6 12.9-12.5zM295.5 299.2l16-8.4 16 8.4-3.1-17.7 13-12.4-17.9-2.6-8-16-8 16-17.9 2.6 13 12.4zM295.5 180.5l16-8.3 16 8.3-3.1-17.6 13-12.5-17.9-2.6-8-16-8 16-17.9 2.6 13 12.5zM337.4 399.9l-17.9-2.6-8-16-8 16-17.9 2.6 13 12.5-3.1 17.6 16-8.3 16 8.3-3.1-17.6zM469.7 186.6l-8 16-17.8 2.6 12.9 12.4-3.1 17.7 16-8.4 16 8.4-3.1-17.7 13-12.4-17.9-2.6zM469.7 67.9l-8 16.1-17.8 2.5L456.8 99l-3.1 17.6 16-8.3 16 8.3-3.1-17.6 13-12.5-17.9-2.5zM469.7 317.4l-8 16-17.8 2.6 12.9 12.5-3.1 17.6 16-8.3 16 8.3-3.1-17.6 13-12.5-17.9-2.6zM477.7 461.2l-8-16-8 16-17.8 2.6 12.9 12.5-3.1 17.6 16-8.3 16 8.3-3.1-17.6 13-12.5z" fill="#FFFFFF" p-id="24990"></path></svg>
                  </div>
                  <div class="text-white pl-8 pr-2 rounded-full text-sm text-center" style="background: #FDA05E;">US Stock</div>
                </div> -->
              </NuxtLink>
              <div class="p-3">
                <NuxtLink 
          ...
          <div class="mt-3 flex relative">
            ...
            <div class="swiper" style="width:1000px;margin-left:30px;">
              <div class="swiper-wrapper">
                <a :href="'/specialAreas?id=66&keyword=Beauty'" style="width:100%;">
                  <img src="@/assets/images/bander/beauty.png" style="width:100%;" alt="make up products">
                </a>
              </div>
            </div>
          </div>
...
onMounted(()=>{
  ...
  getRate().then((rez)=>{
    ...
    getProductSearchOfferRecommendHandle({ type: 1, pageIndex: 1, pageCount: 24 }).then((res)=>{
    ...
    getHistoricalRecordRecommendations({ type: 1 }).then((res)=>{
...
function toSearch(text,name){
  window.open('../specialAreas?id='+text+'&keyword='+name, '_self')
}
