  ...
  <div>
    <div class="bg-white p-3 grid grid-cols-4 gap-4">
      <div class="col-span-1">
        <div>店铺</div>
        <div class="mt-1">
          <select v-model="source" class="select h-9 p-1">
  ...
  export default {
    data() {
      return {
        ...
        list: [
          // {
          //   img: 'https://cbu01.alicdn.com/img/ibank/O1CN01PjplSl1g3tcw7Jv27_!!2201487064087-0-cib.jpg',
          //   title: '2023秋冬新品潮牌男士上衣圆领卫衣纯色情侣衫260克毛圈圆领男卫',
          //   series: 'Others',
          //   store: ['1'],
          //   stock: 10004,
          //   size: 12,
